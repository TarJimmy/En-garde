...
public class IA_Difficile extends IA{
	 ...
	 */
	public int[] gestionCartes(Jeu jeu) {
	 ...
	 */
	public boolean estToucheAdverse (Jeu jeu) {
	 ...
	 */
	public int distanceApresCoup(int action, int valeurCarte, Jeu jeu) {
		int escrimeurD = 23;
		int escrimeurG = 1;
	 ...
	 */
	public int choisirComplementaire(int valeurCarte , int distanceManquante, Jeu jeu ) {
	 ...
	 */
	public int [][] cartesEtActionsPossibles ( int phase, Jeu jeu){
		int k = 0;
	 ...
	 */
	public int [] choix (int [][] tabRes, int [][] choixActions, Jeu jeu) {
	 ...
	 */
	public boolean estCoupFort(int valeurCarte1 , int valeurCarte2  , int nbCartes, Carte[] cartes, Jeu jeu) {
	 ...
	 */
	public int carteMoinsProbable(Carte[] cartes, Jeu jeu) {
		int distanceOpti = 0;
		int tmp = 0;
		int carteOpti =0;
		int[] ordreOpti = new int[cartes.length];
	...
	public int[] transfoEnCase(int action, int valeurCarte, int valeurCarte2, boolean estGaucher, int positionG, int positionD) {
		...
		if(action == Coup.ATTAQUEDIRECTE) {
			System.out.println("transfo : " +nbCartesValeur(valeurCarte, 0, jeu.getCurrentEscrimeur().getCartes()));
			res[1] = nbCartesValeur(valeurCarte, 0, jeu.getCurrentEscrimeur().getCartes());
		}else {
			res[1] = 1;
		}
		res[0] = position;
	 ...
	 */
	public int[] jouerPhase1(Jeu jeu){
		int k = 0;
		int [] res;
	 ...
	 * et un int representant la carte jouee.)
	 */
	public int[] jouerPhase2(Jeu jeu){
		int [] res =new int[3]; 
	 ...
	 * et un int representant la carte jouee.)
	 */
	public int[] jouerPhase3(Jeu jeu){
		int [] res = {0,0,0}; 
		Carte[] cartes = jeu.getCurrentEscrimeur().getCartes();
	 ...
	 * et un int representant la carte jouee.)
	 */
	public int[] jouerPhase4(Jeu jeu){
		int [] res = new int[3]; 
	 ...
	 */
	public boolean estBonCoup (Escrimeur e, int valeurCarte, int action, Jeu jeu) {
	...
	public int[] getChoixCoup() {
		System.out.println("getChoixCoup");
		...
		//return actionIA(jeu.copySimple());
		ControlerIA controlerIA = new ControlerIA(jeu.copySimple());
		
		System.out.println(jeu);
		JeuIA jeuEtatCourant = controlerIA.generateNewJeuIA(jeu,jeu.getIndiceCurrentEscrimeur());
		System.out.println(jeuEtatCourant);
		return actionIA(jeu);
	} 
}
